...
public class OptionCardAdapter extends RecyclerView.Adapter<OptionCardAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final OptionCardAdapter.ViewHolder viewHolder, int position) {
        ...
        card.setOnClickListener(option.getOnClickListener());
        card.setTag(option.getOptionName());
    }
    ...
    public void setOptionList(ArrayList<OptionCard> newList) {
        optionList = newList;
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.optionCard) CardView cardView;
